...
public class AddEditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String profileId = getIntent().getStringExtra(AddEditProfileFragment.ARGUMENT_EDIT_TASK_ID);
        ...
        if (addEditProfileFragment == null){
            ...
            if (getIntent().hasExtra(AddEditProfileFragment.ARGUMENT_EDIT_TASK_ID)){
                ...
                bundle.putString(AddEditProfileFragment.ARGUMENT_EDIT_TASK_ID, profileId);
